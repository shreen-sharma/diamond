...
import { LocalPurchaseSupplierInvoiceReportService } from './localPurchaseSupplierInvoiceReport.service';
...
@Component({
  selector: 'localPurchaseSupplierInvoiceReport',
  templateUrl: './localPurchaseSupplierInvoiceReport.html',
  styleUrls: ['./localPurchaseSupplierInvoiceReport.scss'],

})
export class LocalPurchaseSupplierInvoiceReport implements OnInit {
  ...
  error: string = null;
  isLoading = false;
  localPurchaseSupplierInvoiceReportForm: FormGroup;
  ...
  constructor(private router: Router,
    ...
    private service: LocalPurchaseSupplierInvoiceReportService,
    ...
    this.service.getConsolidatedLocalPurchaseInvoiceReport(-1, -1, -1).subscribe((tabList) => {
  ...
  ngOnInit() {
    this.settings = this.prepareSetting();
    this.reportHeading = 'Local Purchase Supplier Report';
  ...
  onUserRowSelect(event: any) {
    console.log(event);
    this.router.navigate(['../LPPartyInvoiceReport', event.data.partyId], { relativeTo: this.route });
  ...
  ConvertToCSV() {
    ...
    new Angular2Csv(this.invoiceList, 'Local Purchase - Supplier', options);
  ...
  createReport() {
    ...
    this.resetTotalCount();
    this.loading = true;
    this.service.getConsolidatedLocalPurchaseInvoiceReport(this.supplier.value == "" ? -1 : this.supplier.value,
  ...
  get amtPer(): number {
    ...
    this.localPurchaseSupplierInvoiceReportForm.markAsPristine();
  }

  private createForm() {
    this.localPurchaseSupplierInvoiceReportForm = this.fb.group({
    ...
    this.month = this.localPurchaseSupplierInvoiceReportForm.controls['month'];
    this.year = this.localPurchaseSupplierInvoiceReportForm.controls['year'];
    this.supplier = this.localPurchaseSupplierInvoiceReportForm.controls['supplier'];
